  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      textTheme: TextTheme(
        ...
        labelMedium: AppTypography.labelMedium.copyWith(color: AppColors.textPrimaryLight),
        labelSmall: AppTypography.labelSmall.copyWith(color: AppColors.textPrimaryLight),
      ),
    );
  }
